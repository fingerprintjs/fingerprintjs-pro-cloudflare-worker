/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 94f295b067836ef1ab58c8e18b6f6a3c)
// Runtime types generated with workerd@1.20260317.1 2026-03-10 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		AGENT_SCRIPT_DOWNLOAD_PATH: string;
		GET_RESULT_PATH: string;
		PROXY_SECRET: string;
		FPJS_INGRESS_BASE_HOST: string;
		INTEGRATION_PATH_DEPTH: number;
	}
}
